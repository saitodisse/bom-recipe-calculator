...
import type { IProduct, IProductionPlan, IProductionPlanEntry } from "@saitodisse/bom-recipe-calculator";
...
export default function ProductionReports(_props: PageProps) {
  ...
  const [productConsumption, setProductConsumption] = useState<ProductConsumption[]>([]);
              ...
              <tbody>
                {productConsumption.map((item) => (
                  <tr key={item.productId} className="hover:bg-background/5">
                    <td className="p-2 border-b border-border">{item.productName}</td>
                    <td className="p-2 border-b border-border">{item.category}</td>
                    <td className="p-2 text-right border-b border-border">{item.totalQuantity}</td>
                    <td className="p-2 border-b border-border">{item.unit}</td>
                  </tr>
                ))}
              </tbody>
            </table>
